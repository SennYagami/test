...
const UserThemeOptions =
  (): ThemeOptions => /* ** To use mode (light/dark), skin(default/bordered/semi-dark), direction(ltr/rtl), etc. for conditional styles, uncomment below line*/ /* const { settings } = useSettings()*/ /* ** To use mode (light/dark), skin(default/bordered/semi-dark), direction(ltr/rtl), etc. for conditional styles, uncomment below line*/ /* const { mode, skin, themeColor } = settings*/ /* ** To use core palette, uncomment the below line*/ /* const palette = corePalette(mode, skin, themeColor)*/ ({
    /*
  palette:{
    primary: {
      light: '#9E69FD',
